...
## Enable experimental WebMCP

<WebMCPSetup />

Use HTTPS or localhost. If the UI says **Native WebMCP unavailable**, this page could not detect the browser API. Check the flag, relaunch Chrome and reload the app. Enabling the flag does not connect an AI agent by itself; Chrome’s tool inspector can discover and invoke your registered tools.
...
Complete the [application setup](/docs/installation) first if your app does not yet use shadcn Base UI.
